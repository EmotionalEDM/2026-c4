...
- In verification mode, preserve the internal_capsule schema exactly and keep decision.judgment identical to the approved internal alias for the active probe axis.
